...
column_description <- tibble::tribble(
  ...
  "`select`",  "Does any of the 'truth'-words have the selective function (in terms of Beekhuizen et al. 2023)?", "The real problem is that we don’t have water. [That’s what we need to focus on]",
