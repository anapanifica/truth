...
column_description <- tibble::tribble(
  ...
  "`int_adv`",  "Can any of the 'truth'-words be used as an intensifier of a nominal predicate?", "I’m very happy that he came",
  "`really_pred`",  "Is any of the 'truth'-words colexified with 'really'?", "I am really writing a book [even though they said I couldn’t]",
